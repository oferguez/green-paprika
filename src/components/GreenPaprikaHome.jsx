...
export default function GreenPaprikaHome() {
  return (
      ...
      <div className="gp-shell">
        <section className="gp-layout">
          ...
          <section className="gp-panel gp-content-panel">
            ...
            <p className="gp-note">
              Spaces are limited to 10 so early booking is recommended. The exact Golders Green
              location is confirmed when booking. Book here{' '}
              <a
            ...
            <section className="gp-content-block">
              ...
              <p className="gp-body-copy">
                Green Paprika is a London vegan Hungarian pop-up and takeaway kitchen, serving
                traditional Hungarian dishes as generous, comforting plant-based food.
              </p>
              <p className="gp-body-copy">
                Through supper events, pop-up dinners, popup collaborations, and takeaway food,
                Green Paprika serves plant-based Hungarian cooking across London.
              </p>
            </section>
            ...
            <div className="gp-actions">
              ...
              <a
                ...
                title="Instagram"
              >
                <svg className="gp-instagram-icon" viewBox="0 0 24 24" aria-hidden="true">
